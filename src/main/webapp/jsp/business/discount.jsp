...
<body>
		...
		<table class="table table-hover">
			<thead>
				<tr>
					...
					<th width="6%"><s:text name="activity-count" /></th>
					<!--  -->
					<th width="6%"><s:text name="activity-price" /></th>
					<th width="6%"><s:text name="activity-cheap" /></th>

					<th width="8%"><s:text name="activity-used" /></th>
					<th width="8%"><s:text name="setup" /></th>
					<th width="8%"><s:text name="revoke" /></th>
				</tr>
			</thead>
			<tbody id="data"></tbody>
		</table>
	...
	<div id="editor">
		<table class="table table-hover table-edit">
			...
			<tr>
				<th><s:text name="activity-discount-count" /></th>
				<td><input class="text" id="count"></td>
			</tr>
			<tr>
				<th><s:text name="activity-discount-pattern" /></th>
				<td id="pattern"><label><input type="radio" name="pattern" value="discount" checked> <s:text name="activity-discount" /></label> <label><input type="radio" name="pattern" value="percent"> <s:text name="activity-percent" /></label></td>
			</tr>
			<tr class="pattern-discount">
				<th><s:text name="activity-discount-price" /></th>
				<td><input class="text" id="discount"></td>
			</tr>
			<tr class="pattern-percent">
				<th><s:text name="activity-discount-percent" /></th>
